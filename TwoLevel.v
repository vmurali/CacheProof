Require Import DataTypes Induction.
Require Import Channel Cache Compatible L1.
...
Module Type LatestValueAxioms (ch: ChannelPerAddr dt) (l1: L1Axioms dt).
  Import dt ch l1.
...
Module LatestValueTheorems (ch: ChannelPerAddr dt) (c: BehaviorAxioms dt ch)
       (l1: L1Axioms dt) (comp: CompatBehavior dt ch) (lv: LatestValueAxioms ch l1).
