...
Module Final (dt: DataTypes) (ch: ChannelPerAddr dt) (st: Stuff dt ch).
  ...
  Section Pair.
    ...
    Lemma pRespFifo: forall {a ts1 ts2 tr2 m1 m2},
      ...
      pose proof (sendmImpRecvr markm2) as [r2 recvr2].
    ...
    Proof.
      ...
      pose proof (sendmImpRecvr sendm1) as [r1 recvr1].
      pose proof (sendmImpRecvr sendm2) as [r2 recvr2].
      ...
      assert (noRecv: ~ exists t, t3 <= t < t4 /\ exists m, recv mch p c a t m) by (
                                                                                    ...
                                                                                    destruct opts as [t5EqT1 | [t5LtT1 | t5GtT1]]; [
                                                                                      ...
                                                                                      pose proof (sendmImpRecvr sendm) as [r recvr];
    ...
    Proof.
      ...
      pose proof (sendmImpRecvr msendmp) as [r rrecvr].
      pose proof (recvImpMark rrecvr) as [t' [t'Le0 rsendr]].
      ...
      pose proof (sendmImpRecvr sendm) as [r1 recvr1].
