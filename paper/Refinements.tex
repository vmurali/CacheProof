...
Since Invariant~\fullref{conservative} depends solely on the fundamental
Invariants~\fullref{stateChange}, \fullref{noCross} and \fullref{respFIFO}, it
holds true as long as the 3 fundamental invariants hold (which is the case in
the MOSI protocol). The proof of Invariant~\fullref{localCompatibility1} in
