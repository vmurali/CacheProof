...
* Present work
- Abstract converted into ``have showns''
- Replacement policies/policies to decide when a request a sent etc (along with
  associativity/sizing of caches) is parameterized
* Future work
- Forward progress/liveness property
  - closely related to network/buffers
  - in presence of bounded buffers
  - in presence of communication fabric
- Automating Bluespec specification into Coq/vice versa
  - Verified compiler
