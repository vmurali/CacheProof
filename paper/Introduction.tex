...
%This requires that the protocol description includes many important
%implementation-level details which had previously been elided for simplicity
%of the description. Practically, beyond some additional descriptional noise in
%the proof this is not a show stopper.

The issue with this protocol transliteration approach is that design of a
...
% about parts of the
%design to be true for the full system correctness.
