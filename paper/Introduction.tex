...
model-checking based approaches has only 12 processors. \xxx{citation:
http://www.cs.utah.edu/formal\_verification/pdf/xiaofang\_dissertation.pdf (used
data from their related work must cite)}.
...
Protocols, post verification, are often described via Term Rewrite Systems
(TRS) \adamc{citation for TRSes?}, which apply equational logic to describe
