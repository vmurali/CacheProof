...
\fullref{nonAncestorCompatible} and \fullref{latestValue} require further
...
We prove Invariant \fullref{latestValue} via strong induction on time. Consider
...
suffice in proving Invariants~\fullref{localCompatibility1} and
\fullref{localCompatibility2}. Proof of
Invariant~\fullref{noTransitWrite} is similar to the proof of
