...
the cache tree hierarchy, from Invariants \textit{conservative} and
...
and Invariants \textit{conservative} and the first part
...
Invariant \textit{nonAncestorCompatibility}.

We prove Invariant \textit{latestValue} by strong induction on
