...
conditions for Theorem~\fullref{storeAtomicity} are satisfied given Invariants
...
\fullref{nonAncestorCompatible} and \fullref{latestValue} requires further
...
\fullref{conservative} and the fact that the $\ge$ relation is preserved for the
...
Invariants~\fullref{localCompatibility1} and
\fullref{localCompatibility2}. Proof of Invariant~\fullref{noTransitWrite} is
similar to the proof of Invariant~\fullref{nonAncestorCompatible}.
