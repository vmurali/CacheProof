...
that change, the rest of the states remain as is. The notation ($x \Leftarrow
...
atomicity, is generated as follows: the \labelR{} field contains $(c, c.\pos)$
pair, the \dataR{} field contains the value $c.\data[a]$, and \timeR{} field
contains the number of transitions that has taken place in the system before
